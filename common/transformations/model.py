...
def get_warp_matrix(device_from_calib_euler: np.ndarray, intrinsics: np.ndarray,
                    bigmodel_frame: bool = False, camera_from_device_euler: np.ndarray | None = None) -> np.ndarray:
