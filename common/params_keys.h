...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DriverMonitoringEnabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"DriverMonitoringTimeMultiplier", {PERSISTENT | BACKUP, FLOAT, "3.0"}},
    {"DriverMonitoringTimeMultiplierIndex", {PERSISTENT | BACKUP, INT, "2"}},
    ...
    {"LanguageSetting", {PERSISTENT | BACKUP, STRING, "main_zh-CHS"}},
    ...
    {"Brightness", {PERSISTENT | BACKUP, INT, "1"}},
